...
<div class="welcome">
	<div class="container">
		<div class="agileits-title wow fadeInUp animated">
			<h3 class="agileits-title w3title1"><?php echo $lenguage['servicio_sitar'] ?></h3>
			<p class="top-p"><?php echo $lenguage['sitar_serv'] ?></p>
		</div> 
		<div class="w3ls-row wow slideInRight animated">
			...
			<div class="col-md-6 ">
				<div class="welcome-agiletext" style="padding: 0em 3em; ">
					...
					<p><?php echo $lenguage['sitar_ext'] ?></p>
				</div>
			</div>
		...
		<div class="w3ls-row ">
			<div class="col-md-6 wow slideInLeft animated">
				<div class="welcome-agiletext" style="padding: 1em 3em;">
					...
					<p style="font-size: 15px;"><?php echo $lenguage['sitar_conciliacion'] ?></p>
				</div>
			</div>
			<div class="col-md-6 wow slideInRight animated">
				<div class="welcome-agiletext" style="padding: 1em 3em;">
					<h4> <?php echo $lenguage['principales_presentaciones'] ?> </h4>
					<p><?php echo $lenguage['sitar_prestaciones'] ?></p>
				</div>
			</div>
			<div class="clearfix"> </div>
		</div>
