...
<div class="reservation-info"> 
	<div class="reservation">
		<div class="container">			
			<div class="col-md-8 book-reservation wow slideInLeft animated">
				<h2 class="agileits-title w3title2">SOLUCIONES A MEDIDA</h2>
				<h4>SERVICIOS TRANSACCIONALES </h4>
				<p>El mercado de nuestros clientes es de alta rivalidad competitiva en la mayoría de los casos, y está demandando revisar y repensar los segmentos de mercado seleccionados y los posicionamientos de mercado elegidos, y a consecuencia de esto redefinir los modelos de atención basándose en las necesidades de cada segmento seleccionado, en lugar del estándar general de prestación actual utilizado para diferentes segmentos al mismo tiempo.</p>
			</div>
...
<section class="services-section relative">
    <div class="container">
        <div class="col-md-4 service-title-section">
            <h2 class="title">
                <span>Nuestras</span>
                Soluciones            
			</h2>
